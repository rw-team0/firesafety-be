...
public interface DashboardMapper {
    ...
    long countAccessiblePanels(@Param("userId") Long userId, @Param("superAdmin") boolean superAdmin);
    ...
    long countUnconfirmedAlerts(@Param("userId") Long userId, @Param("superAdmin") boolean superAdmin);

    // 접근 가능한 활성 분전반의 미조치 경보 개수 조회
    long countUnresolvedAlerts(@Param("userId") Long userId, @Param("superAdmin") boolean superAdmin);
